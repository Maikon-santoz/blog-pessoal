...
//indica que a classe """ é uma classe de test
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
//indica que o teste a ser feito vai ser um teste unitario
...
public class UsuarioRepositoryTest {
	...
	//inserindo usuarios no meu banco de dados h2 p/ testar funçoes de procura usuario por nome e email
	@BeforeAll
	void start () {
	...
	public void deveRetornarUmUsuario() {
		// o que eu espero receber da api, buscando usuario pelo email
		Optional<Usuario> usuario = usuarioRepository.findByUsuario("joao@email.com.br");
		// comparando se oque eu esperava receber
